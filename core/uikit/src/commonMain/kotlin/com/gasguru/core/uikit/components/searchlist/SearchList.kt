...
import com.gasguru.core.uikit.generated.resources.search_list_clear_description
import com.gasguru.core.uikit.generated.resources.search_list_empty_recent
import com.gasguru.core.uikit.generated.resources.search_list_empty_suggestions
import com.gasguru.core.uikit.generated.resources.search_list_recent_title
import com.gasguru.core.uikit.generated.resources.search_list_suggestions_title
...
fun SearchList(
    ...
    if (model.items.isEmpty()) {
        EmptySearchList(type = model.type, modifier = modifier)
    } else {
        SearchListContent(model = model, modifier = modifier)
    }
}
...
private fun SearchListContent(
    ...
    val title = when (model.type) {
        SearchListType.RECENT -> stringResource(Res.string.search_list_recent_title)
        SearchListType.SUGGESTIONS -> stringResource(Res.string.search_list_suggestions_title)
    }
    ...
    Column(
        ...
        Row(
            ...
            if (model.type == SearchListType.RECENT && model.onClear != null) {
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.search_list_clear_description),
        ...
        LazyColumn(modifier = Modifier.fillMaxWidth()) {
            items(model.items) { item ->
                PlaceItem(model = item, isLastItem = false)
            }
        }
    }
}
...
private fun EmptySearchList(
    ...
    val emptyMessage = when (type) {
        SearchListType.RECENT -> stringResource(Res.string.search_list_empty_recent)
        SearchListType.SUGGESTIONS -> stringResource(Res.string.search_list_empty_suggestions)
    }
