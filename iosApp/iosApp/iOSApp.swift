...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    private func initKoin(launchOptions: [UIApplication.LaunchOptionsKey: Any]?) {
        ...
        // Select the data source module at compile-time based on the active scheme.
        // GasGuru-Mock scheme injects SWIFT_ACTIVE_COMPILATION_CONDITIONS=MOCK via xcconfig
        // (generated by EnvironmentsConventionPlugin from versions.properties).
        // GasGuru-Prod scheme uses SupabaseRemoteDataSource.
        #if MOCK
